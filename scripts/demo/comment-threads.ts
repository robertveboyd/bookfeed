...
> = {
  ...
  "robert|a game of thrones|started_reading": [
    {
      author: "jordan",
      body: "you finally started A Game of Thrones — about time",
      daysAgo: 2,
      likedBy: ["robert", "sam"],
    },
    {
      author: "robert",
      body: "page 100 and I already need a family tree. no spoilers please",
      daysAgo: 2,
      likedBy: ["jordan", "maya"],
    },
    {
      author: "sam",
      body: "the POV hopping clicks after a bit — hang in there",
      daysAgo: 1,
      likedBy: ["robert", "jordan"],
    },
  ],
  "robert|a game of thrones|finished_reading": [
    {
      author: "maya",
      body: "already?! how did you find it?",
      daysAgo: 0,
      likedBy: ["robert", "jordan"],
    },
    {
      author: "robert",
      body: "I couldn't put it down!  George R. R. Martin is a master at world building and the POV perspectives really let you get in the character's heads",
      daysAgo: 0,
      likedBy: ["maya", "sam", "harper"],
    },
    {
      author: "jordan",
      body: "I love that series!  Hoping a Winds of Winter is published out this year",
      daysAgo: 0,
